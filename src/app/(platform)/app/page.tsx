...
import { ContentArea, PageLayout, Panel, Sidebar, SplitPageLayout } from '@/components/product';
            ...
            <Panel tone="elevated">
              <Stack gap="5">
                ...
                <Text textStyle="bodyMuted" color="fg.muted">
                  Сначала текущий курс и точка продолжения. Ниже — остальные программы, к которым у вас уже открыт доступ.
                </Text>

                <Stack gap="3">
                  {summaries.slice(0, 3).map((summary) => (
                    <Panel key={summary.course.id} tone="default" p="4">
                      <Stack gap="2">
                  ...
                  <HStack align="start" justify="space-between" gap="4">
                    <Stack gap="4">
                      ...
                      <Text textStyle="body" color="fg.muted" maxW="2xl">
                        Главный фокус этого экрана — вернуть вас в текущий курс и сразу показать, какой следующий шаг уже ждёт в маршруте.
                      </Text>
                    </Stack>
              ...
              <Panel tone="elevated">
                <Stack gap="6">
                  <Stack gap="3">
                    ...
                    <Text textStyle="bodyMuted" color="fg.muted">
                      Ниже собраны все курсы без лишнего визуального шума: сначала название и состояние, затем быстрый вход в нужную точку.
                    </Text>
                  </Stack>
                  ...
                  <Stack gap="4">
                    {summaries.map((summary) => {
                      ...
                      return (
                        <Panel key={summary.course.id} tone="default" p="5">
